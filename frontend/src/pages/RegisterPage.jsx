...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div
        className="relative bg-cover bg-center order-1 md:order-2 h-36 md:h-auto"
        style={{
          backgroundImage:
      ...
      >
        <div className="absolute inset-0 flex items-end p-6 md:p-10">
          <div>
            <div className="inline-block bg-brand-yellow text-black font-bold uppercase tracking-widest px-2 md:px-3 py-0.5 md:py-1 border-2 border-black shadow-comic mb-2 md:mb-3 text-[10px] md:text-xs">
              BOOM!
            </div>
            <div className="font-display text-3xl md:text-6xl text-white leading-none drop-shadow-[4px_4px_0px_#000]">
              EVERY REP COUNTS
            </div>
          </div>
        </div>
